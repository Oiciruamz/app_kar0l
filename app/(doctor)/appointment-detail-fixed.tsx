...
export default function AppointmentDetailScreen() {
  ...
  const handleScheduleNewAppointment = async () => {
    ...
    try {
      ...
      // Cargar especialidades y doctores (incluir al doctor actual para días diferentes)
  ...
  const handleDoctorSelect = async (doctor: Doctor) => {
    ...
    try {
      ...
      // Cargar slots disponibles para el doctor seleccionado
    ...
    <View style={styles.container}>
      ...
      >
        ...
        >
          ...
          >
            {/* Selección de doctor */}
            <Text style={styles.modalSectionTitle}>👨‍⚕️ Seleccionar Doctor</Text>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              {doctors.map((doctor) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.doctorCard,
                    selectedDoctor?.uid === doctor.uid && styles.selectedDoctorCard
                  ]}
                  onPress={() => handleDoctorSelect(doctor)}
                >
                  <Text style={selectedDoctor?.uid === doctor.uid ? styles.doctorNameSelected : styles.doctorName}>
                    {doctor.displayName}
                  </Text>
                  <Text style={selectedDoctor?.uid === doctor.uid ? styles.doctorSpecialtySelected : styles.doctorSpecialty}>
                    {doctor.specialty}
                  </Text>
                </TouchableOpacity>
              ))}
            ...
            {selectedDoctor && (
              <>
                <Text style={styles.modalSectionTitle}>📅 Seleccionar Horario</Text>
                {loadingSlots ? (
